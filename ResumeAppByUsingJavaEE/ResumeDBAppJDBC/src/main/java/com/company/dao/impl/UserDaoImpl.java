...
public class UserDaoImpl extends AbstractDAO implements UserDaoInter {
    ...
    private User getUser(ResultSet rs) throws Exception {
        ...
        return new User(id, name, surname, email,address, phone, profileDesc, birthdate,nationality, birthplace );
    }
    ...
    private User getUserSimple(ResultSet rs) throws Exception {
        ...
        User u = new User(id, name, surname,address,phone, email,profileDesc,birthdate,null,null);
